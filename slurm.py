...
def build_slurm_cmd(start_cmd, args):
    ...
    assert args.test_time != None, "Test Time not specified, include specifier '--test_time seconds' for total test time \n (RECOMMENDED - Hybrid = 5400 seconds total, All Others = 3600 seconds total)"
    run_seconds = args.test_time # approximately X seconds per a given test
...
def main():
    ...
    arg_parser.add_argument("--test_time", "--tt", type=int, default=None, help="(int) (DEFAULT=None) 100 test - hybrid = 5400 seconds, 100 test - original = 3600 seconds.")
